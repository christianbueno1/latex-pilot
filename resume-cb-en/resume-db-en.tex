...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  ...
  \href{https://www.christianbueno.me}{\uline{christianbueno.me}} $|$ % row = 2, col = 1
  ...
  Email: \href{mailto:hola@christianbueno.me}{\uline{hola@christianbueno.me}} \\ % row = 2, col = 2
...
\small{
  ...
  Hi! I'm Christian Bueno, a \textbf{Full Stack Developer and DevOps} Specialist with over 6 years of experience building tech solutions from Guayaquil, Ecuador. I hold a degree in Computer Science from ESPOL, and my passion for coding started back in school. I specialize in crafting web applications with elegant interfaces, efficient backend systems, and automated deployments. I work with modern tools like Next.js, Tailwind, FastAPI, Django, and Kubernetes. My focus is on blending performance, accessibility, and user experience. In DevOps, I rely on tools like Terraform, Jenkins, and Podman to scale projects reliably. I believe in purposeful development—automating the repetitive, writing clean code, and always designing with clarity and impact.
