...
\begin{tabular}{@{}p{3.2cm}l@{}}
  ...
  \textbf{Lenguajes:} & Python, JavaScript, TypeScript, Java 25 \\
  ...
  \textbf{Bases de Datos:} & PostgreSQL 18, MySQL/MariaDB, SQL Server, MongoDB, Apache Cassandra \\
...
\section{Biografía}
\small{
  \textbf{Desarrollador Full Stack, Backend y Especialista DevOps} con más de 6 años de experiencia construyendo y desplegando soluciones tecnológicas. Estudiante de Ingeniería en Computación en ESPOL (próximo a graduarse). Me especializo en desarrollo de aplicaciones web modernas, APIs RESTful y automatización de infraestructura. Trabajo con tecnologías como \textbf{React}, \textbf{TypeScript}, \textbf{Spring Boot 4}, \textbf{FastAPI} y \textbf{Kubernetes}. Desarrollo APIs RESTful con \textbf{Java 25} aplicando seguridad moderna (autenticación passwordless OTT, \textbf{RBAC}, cifrado de secretos con \textbf{SOPS + age}). En DevOps, uso \textbf{Podman}, \textbf{OpenTofu}, \textbf{Ansible} y \textbf{CI/CD} para escalar proyectos de forma confiable. He desplegado 7+ proyectos en producción incluyendo e-commerce, SaaS y sistemas corporativos. Busco oportunidades para trabajar en proyectos desafiantes que combinen desarrollo full stack con prácticas DevOps modernas.
}
%--------------------------------------------
