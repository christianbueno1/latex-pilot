...
\resumeHeadingListStart{}
  ...
  \resumeQuadHeading{Desarrollador IA / Backend}{2025 -- 2026}
  ...
  \resumeQuadHeading{Desarrollador Backend}{2025 -- 2026}
  {StockPilot API --- Proyecto Personal}{Guayaquil, Guayas, Ecuador}
    ...
    \resumeQuadHeading{Desarrollador Full Stack}{2025 -- 2026}
    {Clasify --- Proyecto Personal}{Guayaquil, Guayas, Ecuador}
      \resumeItemListStart{}
        \resumeItem{Construí marketplace full-stack de tutorías con \textbf{ASP.NET Core Web API} y \textbf{Blazor Server} (.NET 10), habilitando registro y verificación de profesores, reservas y reseñas para estudiantes.}
        \resumeItem{Apliqué \textbf{Clean Architecture} en 4 capas (Domain, Application, Infrastructure, API) y diseñé modelo \textbf{Person}-céntrico con roles \textbf{[Flags]} (\textbf{Teacher}/\textbf{Student}) para evitar duplicidad de perfiles.}
        \resumeItem{Implementé autenticación segura con \textbf{JWT Bearer} (access tokens de 15 min), refresh tokens rotativos de 7 días, logout real con blocklist \textbf{jti} en \textbf{Redis} y hashing de contraseñas con \textbf{PBKDF2}.}
        \resumeItem{Implementé verificación de profesores por admin y suscripciones por niveles \textbf{Free / Starter / Pro} para controlar acceso a funcionalidades del perfil docente.}
        \resumeItem{Desarrollé recursos REST (Auth, Teachers, Students, Subjects, Bookings, Reviews, Availability y Subscriptions) con soft delete, paginación y filtros.}
        \resumeItem{Monté infraestructura local reproducible con \textbf{Podman} (\textbf{PostgreSQL 18 + pgvector} y \textbf{Redis} en pods/red dedicada con volúmenes persistentes) usando script único de aprovisionamiento.}
      \resumeItemListEnd{}

\resumeQuadHeading{Desarrollador Cloud / Backend}{2024 -- 2025}
