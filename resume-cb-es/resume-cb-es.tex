...
\begin{tabular}{@{}p{3.2cm}>{\raggedright\arraybackslash}p{12.8cm}@{}}
  ...
  \textbf{Lenguajes:}      & Python 3.13, JavaScript, TypeScript, Java 25                                                   \\
  ...
  \textbf{IA / LLM:}       & LangChain, LangGraph, LangMem, OpenAI API (GPT-4o-mini), pgvector                              \\
  \textbf{Frameworks:}     & NestJS, Express.js, FastAPI, Django, Flask, Tailwindcss, Next.js                               \\
  \textbf{Bases de Datos:} & PostgreSQL 18, pgvector, MySQL/MariaDB, SQL Server, MongoDB, Apache Cassandra                  \\
  \textbf{Seguridad:}      & Spring Security 7 (OTT passwordless), RBAC, SOPS + age (AES256-GCM)                            \\
  \textbf{Herramientas:}   & Git, Vite, AWS, Linode, Docker, Podman, Linux, Node.js, uv                                     \\
