...
\usepackage{tabularx}     % tablas mejoradas con anchos de columna flexibles
...
%--------REDEFINICIONES----------------
% redefine el estilo del punto de viñeta
...
% resumeSectionType renderiza un tipo en negrita para usar bajo una sección
% usado para tipo de habilidad aquí, el elemento del medio mantiene los ":" en la misma línea vertical
...
% resumeTrioHeading renderiza tres elementos en tres columnas
% segundo elemento en cursiva y primer elemento en negrita, se puede usar para proyectos con tres elementos
...
% resumeQuadHeadingChild renderiza la segunda fila de resumeQuadHeading
% se puede usar para experiencia si se necesitan agregar diferentes roles en la misma empresa
...
% comandos para detalles de contacto - código más limpio
\newcommand{\name}[1]{\textbf{\Huge #1}}
\newcommand{\contactInfo}[2]{#1 & #2 \\}
\newcommand{\socialLinks}[1]{#1}
\newcommand{\separator}{$|$}
% para usar puntos como separadores en lugar de pipes
