...
\resumeQuadHeading{Analista de Datos}{Ag 2024 -- Set 2024}
  ...
  \resumeItemListStart{}
    ...
    \resumeItem{Automatizé operaciones con archivos de Excel, reduciendo el tiempo de entrada manual de datos en aproximadamente un 75\%.}
...
%       \resumeItemListStart{}
%         \resumeItem{Diseñe y Desarrolle un limpio y moderno sitio web usando \textbf{HTML, CSS, JavaScript, React.js, Tailwindcss, GSAP, Typed.js}.}
%         \resumeItem{Sitio web optimizado para la \textbf{velocidad y experiencia de usuario.}}
%         \resumeItem{\textbf{Diseño responsivo} utilizado para asegurar la compatibilidad a través de todos los dispositivos.}
%         % \resumeItem{Deployed on GitHub pages via GitHub Actions}
%         \resumeItem{Desplegado en un Servidor virtual Linux usando Linode, git, rsync.}
%       \resumeItemListEnd{}
...
\section{Educación}
  \resumeHeadingListStart{}
    \resumeQuadHeading{Escuela Superior Politecnica del Litoral - ESPOL}{Guayaquil, Guayas, Ecuador}
