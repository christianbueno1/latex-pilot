...
\resumeItem{Monté infraestructura local reproducible con \textbf{Podman} (pods, redes y volúmenes) para \textbf{SQL Server 2025}, \textbf{Redis 8.6.1} y \textbf{Keycloak 26}, con scripts de setup y teardown.}
\resumeItemListEnd{}
